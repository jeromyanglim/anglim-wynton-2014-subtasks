...
debugonce(summarise_statistics)
summarise_statistics(predictive_checks$unconstrained_withoutstrategies$raw_statistics)
...
debugonce(posterior_predictive_check_cus)
